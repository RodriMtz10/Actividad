## Simulación de Memoria Virtual y Algoritmos de Gestión
...
Maneja una memoria limitada y simula la asignación de procesos a la memoria, realizando intercambios de páginas cuando es necesario.
...
El proyecto incluye un sistema de seguimiento para visualizar el estado actual de la memoria y los procesos en ella.
Objetivos:
